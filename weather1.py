...
def data_get():
    city = city_name.get()
    data = requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=860be30f48a408c9aa102b021ad6dd54").json()
...
t_label = Label(win,text="Temperature",font=("Times New Roman",20))
t_label.place(x=25,y=400,height=50,width=210)
t_label1 = Label(win,text="",font=("Times New Roman",20))
